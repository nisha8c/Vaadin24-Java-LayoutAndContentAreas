...
import com.example.application.views.headerfooter.HeaderfooterView;
...
import com.example.application.views.myview3.MyView3View;
...
public class MainLayout extends AppLayout {
    ...
    private SideNav createNavigation() {
        ...
        nav.addItem(
                new SideNavItem("headerfooter", HeaderfooterView.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
        nav.addItem(new SideNavItem("My View3", MyView3View.class, LineAwesomeIcon.PENCIL_RULER_SOLID.create()));
        nav.addItem(
